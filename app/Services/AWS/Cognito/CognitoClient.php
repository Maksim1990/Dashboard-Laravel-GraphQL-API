    ...
    public function resendConfirmationCode(string $clientId, string $username)
    {
        try {
            ...
            throw new GraphqlException($exception->getAwsErrorMessage(), [
                'type' => 'Auth',
                'category' => 'auth',
                'reason' => 'confirmation_code_resending_failed',
                'code' => 401,
            ]);
        }
    }
    ...
    public function forgotPassword(string $clientId, string $username)
    {
        try {
            ...
            throw new GraphqlException($exception->getAwsErrorMessage(), [
                'type' => 'Auth',
                'category' => 'auth',
                'reason' => 'forgot_password_request_failed',
                'code' => 401,
            ]);
        }
    }
    ...
    public function confirmForgotPassword(
        ...
        try {
            ...
            throw new GraphqlException($exception->getAwsErrorMessage(), [
                'type' => 'Auth',
                'category' => 'auth',
                'reason' => 'confirmation_forgot_password_failed',
                'code' => 401,
            ]);
        }
    }
